...
import com.example.examen_daniel_labarca.db.PlaceEntity
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            AppUI(permissionLauncher = permissionLauncher, cameraController = cameraController, appVM = appVM,
                formVM = FormVM())
...
fun listPlacesUI(appVM: AppVM,
    ...
    LazyColumn( modifier = Modifier
        ...
        items(places) {
            place -> PlaceItem(place, appVM = appVM, formVM) {
        ...
        Box(modifier = Modifier
            ...
            Button(onClick = {
                appVM.currentScreen.value = Screen.AddPlace 
            }) {
